...
export const signup = (username, email, password, re_password, first_name, last_name,) => async dispatch => {
    const config = {
        headers: {
            'Content-Type': 'application/json',
            "X-CSRFToken": getCookie("csrftoken")
    ...
    const body = JSON.stringify({ username, email, password, re_password, first_name, last_name });
